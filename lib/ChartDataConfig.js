...
const lineData = PropTypes.shape({
  dataSets: PropTypes.arrayOf(PropTypes.shape({
    ...
    config: PropTypes.shape({
      ...
      mode: PropTypes.oneOf(['LINEAR', 'STEPPED', 'CUBIC_BEZIER', 'HORIZONTAL_BEZIER', 'GRADIENT_CUBIC_BEZIER']),
...
const barData = PropTypes.shape({
  ...
  config: PropTypes.shape({
    ...
    // Corner radius for bars of bar chart: If value is negative then corner radius will be equal to its width else it will be equal to value provided here
